...
import itc.ink.unit_android.LaunchActivity;
import itc.ink.unit_android.MainActivity;
import itc.ink.unit_android.UnitAppApplication;
...
public class SPUtil {
    ...
    private static synchronized SharedPreferences getPreferneces() {
        if (mSharedPreferences == null) {
            ...
            mSharedPreferences = PreferenceManager.getDefaultSharedPreferences(UnitAppApplication.mApplicationContext);
        }
