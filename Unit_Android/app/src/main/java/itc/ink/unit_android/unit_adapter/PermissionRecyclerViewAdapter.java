package itc.ink.unit_android.unit_adapter;
...
public class PermissionRecyclerViewAdapter extends RecyclerView.Adapter<PermissionRecyclerViewAdapter.PermissionViewHolder> implements View.OnClickListener{

    private List<String> mData;
    private Activity mActivity;
    private OnRecyclerViewItemClickListener mOnItemClickListener = null;

    public PermissionRecyclerViewAdapter(List<String> mData,Activity mActivity) {
    ...
    public PermissionViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.permission_list_item, parent, false);
