package itc.ink.unit_android.unit_viewpager.mode;

import android.content.Context;

import itc.ink.unit_android.unit_viewpager.mode.implement.AssertDataLoader;
...
public class DataLoad {
    ...
    public interface OutService {
         ...
         * 加载Banner数据
         */
        Object loadActionBarTitleData(Context mContext);
